...
from lib.models.common import Conv, TPM, Bottleneck, BottleneckCSP, Focus, Concat, Detect, SharpenConv,BasicLayer
...
[ [18, 21, 24], Detect,  [1, [[3,9,5,11,4,20], [7,18,6,39,12,31], [19,50,38,81,68,157]], [128, 256, 512]]], #Detection head 24

[ 17, Conv, [256, 128, 3, 1]],   #25
...
class MCnet(nn.Module):
    def __init__(self, block_cfg, **kwargs):
        ...
        if isinstance(Detector, Detect):
            ...
            with torch.no_grad():
                model_out = self.forward(torch.zeros(4, 3, s, s))
